...
<body>
    <nav class="navbar navbar-light navbar-expand-md sticky-top py-3" id="mainNav" style="background: var(--bs-gray-500);position: sticky;">
        <div class="container-fluid"><a class="navbar-brand d-flex align-items-center" href="#"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
                    ...
                    </svg></span><span>XYZ Food Orders</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-2"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
    ...
    <section class="py-4 py-xl-5">
        <div class="container">
            <div class="border rounded border-0 d-flex flex-column justify-content-center align-items-center p-4 py-5" style="background: linear-gradient(rgba(0,123,255,0.2), rgba(0,123,255,0.2)), url(assets/menu/menu_header.webp) center / cover;height: 500px;">
                <div class="row">
    ...
    <form action="" method="post">
        <div class="container" style="margin-bottom: 35px;margin-top: 11px;">
            <div class= "row">
                <div class="col" style="margin-top: 5px;"><img class="img-fluid" width="300" height="300" style="padding-top: 0px;padding-right: 0px;padding-bottom: 0px;padding-left: 0px;margin-bottom: 30px;margin-top: 0px;" src="assets/menu/pizza.jpg"></div>
                <div class="col">
                    <h1>Pizza</h1>
                    <p>The food that goes with almost all occasions.</p>
                    <p><b>BDT 200</b></p>
                    <input type="checkbox" name="pizza" value="pizza" style="width: 50px;height: 50px;border-radius: 0px;">
                </div>
            </div>
        </div>
        <div class="container" style="margin-bottom: 35px;margin-top: 11px;">
            <div class="row text-center">
                <div class="col"><button class="btn btn-primary" type="submit" style="background: var(--bs-green);">Proceed To Checkout!</button></div>
            </div>
        </div>
    </form>
