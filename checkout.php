...
<body style="background: var(--bs-border-color);">
    <nav class="navbar navbar-light navbar-expand-md sticky-top py-3" id="mainNav" style="background: var(--bs-gray-500);position: sticky;">
        <div class="container-fluid"><a class="navbar-brand d-flex align-items-center" href="#"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
                    ...
                    </svg></span><span>XYZ Food Orders</span></a>
            ...
            <div class="border rounded border-0 d-flex flex-column justify-content-center align-items-center p-4 py-5" style="background: linear-gradient(rgba(0,123,255,0.2), rgba(0,123,255,0.2)), url(assets/img/checkout.webp) center / cover;height: 500px;">
                <div class="row">
                    <div class="col-md-10 col-xl-8 text-center d-flex d-sm-flex d-md-flex justify-content-center align-items-center mx-auto justify-content-md-start align-items-md-center justify-content-xl-center">
                        <div>
                            <h1 class="text-uppercase fw-bold mb-3" style="color: var(--bs-black);">Almost there</h1>
                            <p class="mb-4" style="color: var(--bs-black);font-weight: bold;">Just some necessary information and your food will be on its way...</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <form>
        <div class="container" style="margin-top: 11px;margin-bottom: 27px;">
            <div class="row">
                <div class="col">
                    <h1>Pizza</h1><label class="form-label" style="font-size: 20px;">Quantity</label><input class="form-control" type="text" value="1" style="width: 30%;">
                    <p style="margin-top: 30px;">BDT 200</p>
                </div>
            </div>
        </div>
        ...
        <div class="container" style="margin-bottom: 35px;margin-top: 4%;">
            <div class="row text-center">
                ...
                <div class="col"><button class="btn btn-primary" type="button" style="background: var(--bs-red);">Go Back</button></div>
            </div>
        </div>
    </form>
    <footer class="text-center bg-dark">
        <div class="container text-white py-4 py-lg-5" style="margin-top: -8px;margin-bottom: -8px;">
            ...
            </ul><a href="#" style="color: var(--bs-navbar-active-color);">Contact Us</a>
